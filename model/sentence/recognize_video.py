...
# --- 2. 설정 및 로드 ---
PTH_PATH = "D:\Bit\server\model"
MODEL_PATH = os.path.join(PTH_PATH, "best_sentence_model.pth")
VOCAB_PATH = os.path.join(PTH_PATH, "vocab.json")

#VIDEO_FILE_PATH = "C:/Users/bit/Desktop/sign_language_sen_data/음식을 하다가 손가락을 칼에 베였어요/KETI_SL_0000009215.MTS"
VIDEO_FILE_PATH = "C:/Users/bit/Desktop/KETI_SL_0000000367.avi"
